...
export const popupEditAvatar = document.querySelector('.popup_type_editAvatarPhoto');
...
export const editAvatarButton = document.querySelector('.profile__avatar-block');
